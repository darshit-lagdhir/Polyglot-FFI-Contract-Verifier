...
#
# File Integrity Identifier: 14508e8d52aa0352
# ==============================================================================
...
from module_06_contract_schema import load_contract, ContractValidator, ValidationContext
import sys
...
def main():
    ...
    contract_path = (
        Path(__file__).parent.parent / "01_basic_generation" / "example_library.contract.json"
    )
    ...
    context = ValidationContext(strict_mode=True, treat_warnings_as_errors=False)
