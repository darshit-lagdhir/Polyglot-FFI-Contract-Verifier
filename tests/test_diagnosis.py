...
from polyglot_ffi_verifier.diagnosis import DiagnosticMapper
...
def create_mock_context(temp_dir: str) -> ExecutionContext:
    ...
    return ExecutionContext(
        ...
        verification_config=VerificationConfig(42, 5, 300, "monitor", True, "normal"),
