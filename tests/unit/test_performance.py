...
from module_05_ir_normalization.performance import (
    PerformanceProfiler, OptimizedTypeDeduplicator,
    OptimizedPaddingComputer, BenchmarkSuite, BenchmarkResult
)
...
class TestBenchmarkSuite:
    ...
    def test_benchmark_failure_str(self):
        res = BenchmarkResult(name="test", duration=0, throughput=0, memory_mb=0, success=False, error="fail")
