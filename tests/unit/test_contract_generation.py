...
from module_06_contract_schema.clause_types import (
    LayoutClause, NullabilityClause, OwnershipClause, RelationalClause
)
...
class TestRelationalClauseGenerator:
    ...
    def test_buffer_relation_detection(self, generator):
        func = MockIRFunction("f3", "process", parameters=[
            {'name': 'buf', 'is_pointer': True},
            {'name': 'len', 'is_integer': True}
        ])
