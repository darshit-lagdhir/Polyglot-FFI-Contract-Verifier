...
class TestClauseFactory:
    ...
    def test_unsupported_clause_type(self):
        ...
        with pytest.raises(ValueError):
            create_clause_from_type(
                ClauseType.INITIALIZATION,  # Not implemented yet
                "factory_bad",
                ref
            )
