...
from polyglot_ffi_verifier.normalization import IRNormalizer
from polyglot_ffi_verifier.normalization import TypeResolver
from polyglot_ffi_verifier.normalization import QualifierNormalizer
from polyglot_ffi_verifier.normalization import LayoutNormalizer
...
def test_provenance_metadata():
    ...
    try:
        ...
        prov = ir["provenance"]
        assert prov["producing_phase"] == ": Intermediate Representation Normalization"
