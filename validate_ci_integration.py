...
from src.ci.ci_integration_manager import CIIntegrationManager
from src.ci.workflow_template_generator import WorkflowTemplateGenerator
from src.ci.badge_generator import BadgeGenerator
from src.ci.ci_status_checker import CIStatusChecker
from src.ci.configuration_manager import ConfigManager
from src.ci.artifact_publisher import ArtifactPublisher
...
def test_ci():
    ...
    try:
        ...
        summary_warn = {
            "verification_status": "passed", # 1 marks passed if no critical
