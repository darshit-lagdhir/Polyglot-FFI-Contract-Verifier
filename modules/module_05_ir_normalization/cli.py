...
from .ir_orchestrator import (
    IRNormalizationConfig, IROrchestrator,
    OrchestrationError, ConfigError, OrchestrationReport
)
from .ir_serialization import IRArtifact, IRArtifactManager, deserialize_compressed
...
For more information: https://pfcv.readthedocs.io/module_05/
    ...
    normalize_parser.add_argument('-o', '--output', default='.pfcv/ir_artifacts', help='Output directory')
    normalize_parser.add_argument('--compress', action='store_true', default=True, help='Compress artifacts')
    normalize_parser.add_argument('--no-compress', dest='compress', action='store_false')
    normalize_parser.add_argument('--validate', action='store_true', default=True, help='Run validation')
    ...
    normalize_parser.add_argument('--cache', action='store_true', default=True, help='Enable caching')
    normalize_parser.add_argument('--no-cache', dest='cache', action='store_false')
    normalize_parser.add_argument('--cache-dir', default='.pfcv/cache/module_05', help='Cache directory')
    ...
    diff_parser.add_argument('--recommend', action='store_true', help='Show version bump recommendation')
