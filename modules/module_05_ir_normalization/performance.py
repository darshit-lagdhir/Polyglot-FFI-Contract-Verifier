...
from .ir_entities import (
    IREntity, EntityKind, PaddingEntity, TypeEntity, ScalarType,
    PointerType, ArrayType, StructureType, UnionType, EnumerationType
)
...
class OptimizedTypeDeduplicator:
    ...
    def get_or_create_type_id(
        ...
        from .ir_entities import IREntity, EntityKind
