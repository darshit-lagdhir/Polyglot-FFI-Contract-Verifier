...
class VersionHistory:
    ...
    def get_versions_between(
        ...
        return [
            ...
            if start <= e.metadata.version <= end
        ]
...
class ContractDiffer:
    ...
    def diff(
        self,
        old_contract: ContractDocument,
        new_contract: ContractDocument
    ) -> ContractDiff:
        """
    ...
    def recommend_version_bump(
        ...
        if diff.overall_impact == CompatibilityImpact.BREAKING:
            return (
                ...
                "Breaking changes detected (MAJOR bump)"
            )
        ...
        return (
            ...
            "Metadata or documentation changes only (PATCH bump)"
        )
