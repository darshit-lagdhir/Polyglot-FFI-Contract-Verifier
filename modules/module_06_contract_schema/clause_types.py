...
class NullabilityClause(TypedClause):
    ...
    def to_generic_clause(self) -> ContractClause:
        """Convert to generic clause."""
        params = [
            ConstraintParameter("nullable", self.nullable, "boolean")
        ]
...
class OwnershipClause(TypedClause):
    ...
    def to_generic_clause(self) -> ContractClause:
        ...
        params = [
            ...
            ConstraintParameter("allocation_responsibility", self.allocation_responsibility, "string"),
            ConstraintParameter("deallocation_responsibility", self.deallocation_responsibility, "string")
        ]
...
class LifetimeClause(TypedClause):
    ...
    def to_generic_clause(self) -> ContractClause:
        """Convert to generic clause."""
        params = [
            ConstraintParameter("lifetime_scope", self.lifetime_scope, "string")
        ]
        
        if self.invalidation_event:
            params.append(ConstraintParameter("invalidation_event", self.invalidation_event, "string"))
...
class RelationalClause(TypedClause):
    ...
    def to_generic_clause(self) -> ContractClause:
        ...
        if self.relation_expression:
            params.append(ConstraintParameter("relation_expression", self.relation_expression, "expression"))
...
class CallingConventionClause(TypedClause):
    ...
    def validate_parameters(self) -> List[str]:
        ...
        valid_conventions = ["cdecl", "stdcall", "fastcall", "thiscall", "vectorcall", "sysv", "win64"]
