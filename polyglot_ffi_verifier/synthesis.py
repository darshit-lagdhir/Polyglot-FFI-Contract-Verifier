...
From original implementation: Phase 4 (src/synthesis/)
"""
...
class ContractSynthesizer:
    """
    Main engine for Phase 4. Synthesizes semantic constraints from normalized IR.
    """
    ...
    def synthesize(self, context: ExecutionContext) -> Dict[str, Any]:
        ...
        if not os.path.exists(ir_path):
            raise FileNotFoundError(f"IR artifact not found: {ir_path}. Run Phase 3 first.")
